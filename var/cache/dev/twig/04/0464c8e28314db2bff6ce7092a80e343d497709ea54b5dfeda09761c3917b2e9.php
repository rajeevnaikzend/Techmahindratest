...
class __TwigTemplate_52429dddd676c281539fd5265abfeff454fc484664487f4114c7596e332ea59e extends Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"text\" value=\"";
        ...
        echo "\" name=\"username\" id=\"inputUsername\" class=\"form-control w-50\" autocomplete=\"username\" required autofocus>
...
<form method=\"post\">
    ...
    <h1 class=\"h3 mb-3 font-weight-normal\">Please sign in</h1>
    <label for=\"inputUsername\">Username</label>
    <input type=\"text\" value=\"{{ last_username }}\" name=\"username\" id=\"inputUsername\" class=\"form-control w-50\" autocomplete=\"username\" required autofocus>
    <label for=\"inputPassword\">Password</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control w-50\" autocomplete=\"current-password\" required>
    ...
    <a class=\"btn btn-lg btn-primary\" href=\"{{ path('register') }}\"> Register </a>
</form>
{% endblock %}
", "security/login.html.twig", "D:\\xampp\\htdocs\\SymfonyTech\\templates\\security\\login.html.twig");
    }
}
